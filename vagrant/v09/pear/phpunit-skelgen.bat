...
if "%PHPBIN%" == "" set PHPBIN=C:\Program Files (x86)\iis express\PHP\v5.4\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\Raphael\Documents\GitHub\marqurap\vagrant\v09\pear\phpunit-skelgen" %*

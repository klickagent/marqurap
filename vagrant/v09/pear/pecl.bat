...
FOR %%x IN ("C:\Users\Raphael\Documents\GitHub\marqurap\vagrant\v09\pear\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\Raphael\Documents\GitHub\marqurap\vagrant\v09\pear\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\Raphael\Documents\GitHub\marqurap\vagrant\v09\pear"

...
add_action( 'template_redirect',      'cleanhome_infinite_scroll_enqueue_styles', 25 );
 ...
 */
function cleanhome_infinite_scroll_enqueue_styles() {
	// Add theme specific styles.
	wp_enqueue_style( 'infinity-clean-home', plugins_url( 'clean-home.css', __FILE__ ), array(), '2012-06-26' );
}
